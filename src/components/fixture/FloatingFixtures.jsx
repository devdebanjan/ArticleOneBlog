            ...
            <div className="bracket-scroll-container">
              ...
              <div className="match-row finals-row">
                <div className="finals-left">
                  <MatchBox team1="TBD" flag1="🛡️" score1="-" team2="LS2" flag2="🛡️" score2="-" status="Jul 19" badge="BRONZE-FINAL" badgeColor="blue" />
                </div>
                <div className="finals-center">
                  <MatchBox team1="TBD" flag1="🛡️" score1="-" team2="WS2" flag2="🛡️" score2="-" status="Jul 19" badge="FINAL" badgeColor="gold" />
                </div>
              ...
              <div className="bracket-section">
                ...
                <div className="match-row sf-row">
                  <MatchBox team1="TBD" flag1="🛡️" score1="-" team2="TBD" flag2="🛡️" score2="-" status="Jul 15" active={true} />
                </div>
                ...
                <div className="match-row qf-row">
                  <MatchBox team1="NOR" flag1="🇳🇴" score1="-" team2="ENG" flag2="🏴󠁧󠁢󠁥󠁮󠁧󠁿" score2="-" status="Tomorrow" />
                  <MatchBox team1="ARG" flag1="🇦🇷" score1="-" team2="SUI" flag2="🇨🇭" score2="-" status="Tomorrow" />
                </div>
              </div>
